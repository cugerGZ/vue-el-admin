<template>
  <div>
    <el-container style="position:absolute;top:55px;left:0px;right:0;bottom:0">
    ...
    <!-- 预览图片 -->
    <el-dialog :visible.sync="previewModel" width="60vw" top="10vh">
